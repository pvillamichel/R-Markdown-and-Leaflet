...
beach_icon<-makeIcon(iconUrl = "beach_pin.png", iconWidth = 60, iconHeight = 60, iconAnchorX = 30, iconAnchorY = 60)
...
airport_icon<-makeIcon(iconUrl = "airport_pin.png", iconWidth = 60, iconHeight = 60, iconAnchorX = 30, iconAnchorY = 60)
